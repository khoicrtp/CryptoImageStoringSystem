...
def putdata(imagepath):
  timestr = time.strftime("%Y%m%d-%H%M%S")
  storage.child("images/"+timestr).put(imagepath)
...
def downloadImage(filestoragename,outputpath):
    storage.child('images/'+filestoragename).download(outputpath+'/'+filestoragename+'.png')
